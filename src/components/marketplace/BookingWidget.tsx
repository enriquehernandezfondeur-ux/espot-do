        ...
        {step === maxStep && (
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-center gap-2 pt-1 flex-wrap">
              ...
              <img src="/azul.jpg" alt="Azul Payments" style={{ height: 18, width: 'auto', borderRadius: 3, objectFit: 'contain' }} />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/visa.png" alt="Visa" style={{ height: 18, width: 'auto', objectFit: 'contain' }} />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/mastercard.png" alt="Mastercard" style={{ height: 18, width: 'auto', objectFit: 'contain' }} />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/visa-secure.png" alt="Visa Secure" style={{ height: 18, width: 'auto', objectFit: 'contain' }} />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/mastercard-id-check.png" alt="Mastercard ID Check" style={{ height: 18, width: 'auto', objectFit: 'contain' }} />
            </div>
