...
export async function getPublishedSpaces(filters?: {
  ...
  let query = supabase
    ...
    .select(`
      ...
      space_pricing(pricing_type, hourly_price, minimum_consumption, fixed_price, package_name, package_hours, weekend_multiplier, min_advance_amount, min_hours, max_hours, is_consumable, consumable_optional, is_active),
      space_conditions(
