        ...
        <div className="mb-8 rounded-3xl overflow-hidden"
          ...
          <div className="px-8 py-7 flex items-center justify-between gap-6">
            <div>
              ...
              <h2 className="text-2xl font-bold text-white mb-1">{(next.spaces as any)?.name}</h2>
            ...
            <div className="shrink-0 text-right">
              <div className="text-3xl font-bold text-white mb-1">{formatCurrency(Number(next.total_amount))}</div>
