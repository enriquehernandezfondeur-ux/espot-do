...
import { Loader2, MessageCircle, Send, Search, Paperclip, FileText, Download, X, ArrowLeft, Building2, Trash2 } from 'lucide-react'
      ...
      <div className={`w-full md:w-72 md:flex-col md:shrink-0 flex flex-col ${active ? 'hidden md:flex' : 'flex'}`}
        ...
        <div className="flex-1 overflow-y-auto">
          {filtered.length === 0 ? (
            ...
            <div key={conv.spaceId} className="group relative" style={{ borderBottom: '1px solid var(--border-subtle)' }}>
