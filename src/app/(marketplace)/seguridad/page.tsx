...
export const metadata: Metadata = {
  ...
  description: 'Políticas de seguridad para la transmisión de datos de tarjetas de crédito y débito en Espot.',
}
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-8 md:py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
            En Espot la seguridad de tus datos financieros es prioridad. Esta página describe cómo protegemos la información de tus tarjetas de crédito y débito.
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl p-5 md:p-6" style={{ background: '#fff', border: '1px solid var(--border-subtle)' }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              Espot no almacena, procesa ni transmite datos de tarjetas de crédito o débito en sus servidores. Todos los pagos son procesados directamente por <strong style={{ color: 'var(--text-primary)' }}>Azul Payments</strong>, procesador de pagos certificado PCI-DSS, a través de su plataforma <em>Payment Page</em>.
            </p>
            <p className="text-sm leading-relaxed mt-2" style={{ color: 'var(--text-secondary)' }}>
              Cuando el cliente hace clic en "Pagar", es redirigido al dominio seguro de Azul (<strong>pagos.azul.com.do</strong>) donde ingresa sus datos de tarjeta. Espot nunca ve ni toca esa información.
            </p>
          </div>
          ...
          <div className="rounded-2xl p-5 md:p-6" style={{ background: '#fff', border: '1px solid var(--border-subtle)' }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              Todas las transacciones procesadas a través de Espot utilizan el protocolo <strong style={{ color: 'var(--text-primary)' }}>3D Secure</strong>, que añade una capa adicional de verificación de identidad del tarjetahabiente:
            </p>
          ...
          <div className="rounded-2xl p-5 md:p-6" style={{ background: '#fff', border: '1px solid var(--border-subtle)' }}>
            ...
            <ul className="text-sm space-y-2" style={{ color: 'var(--text-secondary)' }}>
              ...
              <li className="flex items-start gap-2"><span style={{ color: 'var(--brand)', marginTop: 2 }}>•</span><span>Reportar cualquier cargo no reconocido inmediatamente a su banco y a Espot.</span></li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl p-5 md:p-6" style={{ background: '#fff', border: '1px solid var(--border-subtle)' }}>
            ...
            <p className="text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
              Para reportar incidentes de seguridad o fraude relacionados con pagos en Espot:
            </p>
