...
export default function MarketplaceLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="light-theme min-h-dvh w-full" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: '#F4F6F5' }}>
        <style>{`
          .ft-link { transition: color .2s ease, padding-left .2s ease; }
          .ft-link:hover { color: #35C493 !important; padding-left: 6px; }
          .ft-social { transition: background .2s ease, transform .2s ease; }
          .ft-social:hover { background: #35C493 !important; color: #fff !important; transform: translateY(-2px); }
          @keyframes ft-glow { 0%,100%{opacity:1} 50%{opacity:.7} }
        `}</style>

        <div className="max-w-7xl mx-auto px-4 md:px-6">

          {/* Top: logo + tagline */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-10 pb-8"
            style={{ borderBottom: '1px solid #E0E7E3' }}>
            <div>
              <Link href="/">
                <img src="/logo-dark.svg" alt="EspotHub" style={{ height: 24, width: 'auto' }} />
              </Link>
              <p className="mt-2 text-sm" style={{ color: '#6B7280', maxWidth: 320 }}>
                El marketplace de espacios para eventos en República Dominicana.
              </p>
            </div>
            {/* Redes */}
            <div className="flex gap-2">
              {[
                ...
                { href:'https://www.linkedin.com/company/espotdo/',   path:'M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 23.2 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z', label:'LinkedIn' },
              ].map(s => (
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer"
                  aria-label={s.label} className="ft-social w-9 h-9 rounded-xl flex items-center justify-center"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 py-8">
            ...
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest mb-4" style={{ color:'#35C493' }}>Plataforma</p>
              <div className="space-y-2.5">
                {[
                  ...
                  <Link key={href} href={href} className="ft-link block text-sm" style={{color:'#6B7280'}}>{label}</Link>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  <Link key={label} href={href} className="ft-link block text-sm" style={{color:'#6B7280'}}>{label}</Link>
                ))}
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-5"
            ...
            <div className="flex items-center gap-2.5 flex-wrap justify-center">
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/azul-logo.jpg"            alt="Azul"               style={{height:18,width:'auto',borderRadius:3,objectFit:'contain'}}/>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/visa-logo.jpg"            alt="Visa"               style={{height:18,width:'auto',borderRadius:3,objectFit:'contain'}}/>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/mastercard-logo.svg"      alt="Mastercard"         style={{height:18,width:'auto'}}/>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/verified-by-visa.png"     alt="Verified by Visa"   style={{height:16,width:'auto'}}/>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/mastercard-id-check.png"  alt="MC ID Check"        style={{height:16,width:'auto'}}/>
            </div>
