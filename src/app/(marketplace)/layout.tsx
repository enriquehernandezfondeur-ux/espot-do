...
export default function MarketplaceLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="light-theme min-h-dvh w-full" style={{ background: 'var(--bg-base)', color: 'var(--text-primary)', overflowX: 'hidden' }}>
      ...
      {/* ── FOOTER ── */}
      <footer style={{ background: '#fff', borderTop: '1px solid #E8EEE9' }} className="px-4 md:px-6 pt-10 pb-0">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pb-10">
            ...
            <div className="col-span-2 md:col-span-1 space-y-4">
              ...
              <p style={{ color: '#6B7280', fontSize: 13, lineHeight: 1.6, maxWidth: 220 }}>
              ...
              <div className="flex gap-2">
                {[
                  ...
                  <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label}
                    ...
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d={s.icon}/></svg>
                  </a>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-3">
              <h4 className="text-xs font-bold uppercase tracking-widest" style={{ color: '#35C493' }}>Marketplace</h4>
              {[
                ...
                <Link key={href} href={href} className="block text-sm link-muted"
                  style={{ color: '#6B7280' }}>
                  {label}
                </Link>
              ))}
            ...
            {/* Anfitriones */}
            <div className="space-y-3">
              <h4 className="text-xs font-bold uppercase tracking-widest" style={{ color: '#35C493' }}>Anfitriones</h4>
              {[
                { href: '/para-propietarios', label: 'Publicar mi espacio' },
                { href: '/dashboard/host',    label: 'Panel de control' },
                { href: '/auth',              label: 'Iniciar sesión' },
              ].map(({ href, label }) => (
                <Link key={label} href={href} className="block text-sm link-muted"
                  style={{ color: '#6B7280' }}>
                  {label}
                </Link>
              ))}
            ...
            {/* Legal */}
            <div className="space-y-3">
              <h4 className="text-xs font-bold uppercase tracking-widest" style={{ color: '#35C493' }}>Legal</h4>
              {[
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 py-4"
            ...
            <div className="flex items-center gap-2 flex-wrap justify-center">
              <span style={{ fontSize: 11, color: '#9CA3AF', fontWeight: 600 }}>Pago seguro</span>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/azul-logo.jpg" alt="Azul" style={{ height: 18, width: 'auto', borderRadius: 3 }} />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/visa-logo.jpg" alt="Visa" style={{ height: 18, width: 'auto', borderRadius: 3 }} />
              {/* eslint-disable-next-line @next/next/no-img-element */}
              ...
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/mastercard-id-check.png" alt="Mastercard ID Check" style={{ height: 16, width: 'auto' }} />
            </div>

            <p style={{ fontSize: 11, color: '#9CA3AF' }}>© 2026 ESPOT, S.R.L. · República Dominicana</p>
          </div>
