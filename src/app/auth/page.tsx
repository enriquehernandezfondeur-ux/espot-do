    ...
    <div className="min-h-dvh flex flex-col"
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(53,196,147,0.09) 0%, transparent 65%)',
        }} />
        <div style={{
          ...
          <div className="w-full max-w-[400px] relative">
            ...
            <div className="flex flex-col items-center mb-7">
              <Link href="/" className="inline-flex mb-3">
                <img src="/logo-green.svg" alt="espot.do" style={{ height: 38, width: 'auto' }} />
              </Link>
              {isHost ? (
                <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-semibold"
                  ...
                  <Building2 size={11} /> Panel de propietarios
                </div>
              ) : (
                <p className="text-sm font-medium" style={{ color: 'rgba(255,255,255,0.4)' }}>
                  Espacios para eventos en RD
                </p>
              )}
            </div>
